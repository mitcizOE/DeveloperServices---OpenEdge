    ...
    public partial class Success : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (responseCode == "1")
            {
                ...
                TransactionStatus.Text = "Your Payment Has Been Accepted." + Environment.NewLine + "TeeTime Date " + HostPayFunctions.DemoVariables.TeeTimeDate + Environment.NewLine + "Authorization Code: " + parsedResult["bank_approval_code"] + Environment.NewLine + "Jake is dumb";
            }
            else
            {
