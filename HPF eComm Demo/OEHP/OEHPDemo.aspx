...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="SubmitButton" runat="server" BackColor="Gray" BorderStyle="None" Font-Bold="True" Height="37px" OnClick="SubmitButton_Click" Text="Enter Card Information" Width="160px" BorderWidth="5px" />
